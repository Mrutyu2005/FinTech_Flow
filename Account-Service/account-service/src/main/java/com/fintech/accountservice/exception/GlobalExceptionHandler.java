...
/**
 * Global Exception Handler — catches all exceptions thrown across controllers
 * and returns clean, structured error responses.
 *
 * Error format:
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleAuthException(
        ...
        log.warn("[AUTH] Authentication failed on path {}: {}", request.getRequestURI(), ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleAccessDenied(
        ...
        log.warn("[ACCESS DENIED] {} tried to access {}", request.getRemoteUser(), request.getRequestURI());
